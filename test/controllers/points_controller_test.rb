...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { address: @point.address, info: @point.info, latitud: @point.latitud, logitud: @point.logitud, subtitle: @point.subtitle, title: @point.title }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { address: @point.address, info: @point.info, latitud: @point.latitud, logitud: @point.logitud, subtitle: @point.subtitle, title: @point.title }
    assert_redirected_to point_path(assigns(:point))
  end
